...
if __name__ == "__main__":
    data_path = "data/xyz_files/benzenes.xyz"
    frames = ase.io.read(data_path, ":")
    ell_frames = ase.io.read("data/xyz_files/ellipsoids.xyz", ":")
    print(len(frames))
    ...
    ase.io.write("data/xyz_files/two_ellipsoids.xyz", two_ellipsoids)