...
class ColumnarLatticeInitializer(Initializer):
    ...
    def __init__(self, n_particles=None, density=None, seed=None, tilt=0.15):
        self.n_particles = DEFAULT_N_PARTICLES if n_particles is None else n_particles
...
def generate_random_config(n_particles=210, density=0.6, seed=None):
    """
...
def generate_columnar_config(n_particles=210, density=1.4, seed=None, tilt=0.15):
    """
